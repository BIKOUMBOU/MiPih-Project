...
<head>
  ...
  <link rel="stylesheet" href="stylew4.css">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a class="navbar-brand" href="#">
    <img src="mipih.png" alt="logo" style="width:100px;">
  </a>
  ...
  <ul class="navbar-nav">
      ...
      <a class="nav-link" href="#">Diffuseur technique</a>
       ...
       <li class="nav-item">
       <a class="nav-link" href="#">Consultant dsn</a>
       </li>
      
       <li class="nav-item">
       <a class="nav-link" href="#">Responsables projets</a>
       </li>
